...
$query="select * from tbl_catinfo";
$user = new ClsDatabase();
$result=$user->selectRecord($query);
    ?>
<?

$page_name="managecat.php"; //  If you use this code with a different page ( or file ) name then change this 
$start=$_GET['start'];
...
$query2="SELECT * FROM tbl_catinfo";
$result2=mysql_query($query2);
echo mysql_error();
$nume=mysql_num_rows($result2);
$query=" SELECT * FROM tbl_catinfo  limit $eu, $limit ";
...
<script type="text/javascript">
	 ...
	 function checkall1()
	 {
		 ...
		 for(var i=0;i<b.length;i++)
			 {
			 if(a.checked==true && b[i].checked==false)
		 {
        ...
        <tr>
          <th width="15" align="center" scope="col"><label>
                  <input type="checkbox" name="checkbox1" id="checkbox1" onclick="return checkall()" />
                   <a href="deletecat.php?did=<?php echo $record["cat_id"];?>" onclick="return confirmdeleteall(<?php echo $record["cat_id"];?>)" ><img src="images/icon_delete.gif" alt="Delete" width="16" height="16" border="0" /></a>
          </label></th>
          <th width="80" scope="col"><a href="#">Category Name</a></th>
          <th width="100" scope="col"><a href="#">Category Status</a></th>
...
?>
        ...
        <tr>
          <td width="15" align="center"><input type="checkbox" name="checkbox2[]" id="checkbox2[]" onclick="return checkall1()" value="<?php echo $record["cat_id"]; ?>" /></td>
          <td width="80"> <?php echo $record["cat_name"]; ?></td>
          <td><?php echo $record["cat_status"]; ?></td>
          <td width="40" align="center"><a href="updatecat.php?edid=<?php echo $record["cat_id"];?>""><img src="images/icon_edit.gif" alt="Edit" width="16" height="16" border="0" /></a>&nbsp;&nbsp;
              <a href="deletecat.php?did=<?php echo $record["cat_id"];?>" onclick="return confirmdelete(<?php echo $record["cat_id"];?>);" ><img src="images/icon_delete.gif" alt="Delete" width="16" height="16" border="0" /></a></td>
  
              <?php
}
  ?>
            <tr>
          <th colspan="5" class="pagination" scope="col"><? if($back >=0) { 
