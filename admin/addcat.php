...
var rn=document.getElementById("catname");
if (rn.value==null || rn.value=="")
	{
    alert("Cetagory must be filled out");
	rn.value = "";
	rn.focus();
  	return false;
	}
...
<!--FORM ELEMENTS EXAMPLE-->  
     ...
     <form action="addcat.php"   method="post" name="form1" class="nice" id="form1" onsubmit="return validateForm()">
        <h2>Add Your Category</h2>
        <table width="500" border="1">
 
  <tr>
    <td ><br />Enter Your Category:</td>
    <td><br /><input name="catname" type="text" class="inputText" id="catname" value=""/></td>
  </tr>
        <p class="left">
