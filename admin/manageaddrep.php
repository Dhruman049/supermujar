...
$page_name="manageaddrep.php"; //  If you use this code with a different page ( or file ) name then change this 
$start=$_GET['start'];
...
<script type="text/javascript">
	 ...
	 function checkall()
	 {
		 ...
		 var b=document.getElementsByName("checkbox2[]");
		 if(a.checked==true)
		 {
	 ...
	 function confirmdelete(id)
	 {
		...
		//alert(sakdopakdpaok);
		//var ch=document.getElementsName(id);
        ...
        <tr>
          <th width="15" align="center" scope="col"><label>
                  <input type="checkbox" name="checkbox1" id="checkbox1" onClick="return checkall()" />
                   <a href="deleteaddrep.php?did=<?php echo $record["rep_id"];?>" onClick="return confirmdeleteall();" ><img src="images/icon_delete.gif" alt="Delete" width="16" height="16" border="0" /></a>
          </label></th>
          <th width="80" scope="col"><a href="#">Recipies</a></th>
          <th width="100" scope="col"><a href="#">Category</a></th>
          <th width="100" scope="col"><a href="#">Sub Category</a></th>
          <th width="100" scope="col"><a href="#">Ingredients</a></th>
          <th width="100" scope="col"><a href="#">Estem Time</a></th>
          <th width="100" scope="col"><a href="#">Recipies Process</a></th>
          <th width="100" scope="col"><a href="#">Recipies Status</a></th>          
...
?>
        ...
        <tr>
          <td width="15" align="center"><input type="checkbox" name="checkbox2[]" id="checkbox2[]" value="<?php echo $record["rep_id"]; ?>" /></td>
          <td width="80"> <?php echo $record["rep_name"]; ?></td>
          <td><?php echo $record["rep_cat"]; ?></td>
          <td><?php echo $record["subcat_name"]; ?></td>
          <td><?php echo $record["rep_ingre"]; ?></td>
          <td><?php echo $record["rep_esttime"]; ?></td>
          <td><?php echo $record["rep_procces"]; ?></td>
           <td><?php echo $record["rep_status"]; ?></td>
            
          
          <td width="40" align="center"><a href="updateaddrep.php?edid=<?php echo $record["rep_id"];?>"><img src="images/icon_edit.gif" alt="Edit" width="16" height="16" border="0" /></a>&nbsp;&nbsp;
              <a href="deleteaddrep.php?did=<?php echo $record["rep_id"];?>" onClick="return confirmdelete();" ><img src="images/icon_delete.gif" alt="Delete" width="16" height="16" border="0" /></a></td></tr>
