...
$query="select * from tbl_subcatinfo";
$user = new ClsDatabase();
$result=$user->selectRecord($query);
    ?>
<?

$page_name="managesubcat.php"; //  If you use this code with a different page ( or file ) name then change this 
$start=$_GET['start'];
...
$query2="SELECT * FROM tbl_subcatinfo";
$result2=mysql_query($query2);
echo mysql_error();
$nume=mysql_num_rows($result2);
$query=" SELECT * FROM tbl_subcatinfo  limit $eu, $limit ";
        ...
        <tr>
          <th width="15" align="center" scope="col"><label>
                  <input type="checkbox" name="checkbox1" id="checkbox1" onClick="return checkall()" />
                   <a href="deletesubcat.php?did=<?php echo $record["cat_id"];?>" onClick="return confirmdeleteall(<?php echo $record["cat_id"];?>)" ><img src="images/icon_delete.gif" alt="Delete" width="16" height="16" border="0" /></a>
          </label></th>
          <th width="80" scope="col"><a href="#">Sub Category Name</a></th>
          <th width="100" scope="col"><a href="#">Category Name</a></th>
          <th width="100" scope="col"><a href="#"> Sub Category Status</a></th>
...
?>
        ...
        <tr>
          <td width="15" align="center"><input type="checkbox" name="checkbox2[]" id="checkbox2[]"
           value="<?php echo $record["cat_id"]; ?>" /></td>
          <td width="80"> <?php echo $record["subcat_name"]; ?></td>
          <td><?php echo $record["cat_name"]; ?></td>
           <td><?php echo $record["subcat_status"]; ?></td>
          <td width="40" align="center"><a href="updatesubcat.php?edid=<?php echo $record["subcat_id"];?>"><img src="images/icon_edit.gif" alt="Edit" width="16" height="16" border="0" /></a>&nbsp;&nbsp;
              <a href="deletesubcat.php?did=<?php echo $record["subcat_id"];?>" onClick="return confirmdelete();" ><img src="images/icon_delete.gif" alt="Delete" width="16" height="16" border="0" /></a></td></tr>
